            ...
            >
                ...
                <div className="card">
                    <div className="card-body">
                        ...
                        <a href="https://github.com/mabthew/sorting-visualizer" target="_blank" rel="noopener noreferrer"><AiFillGithub size={42} /></a>
                ...
                <div className="card">
                    <div className="card-body">
                        ...
                        <a href="https://github.com/mabthew/Dropbucket-deliverables" target="_blank" rel="noopener noreferrer"><AiFillGithub size={42} /></a>
                    </div>
                </div>
                <div className="card">
                    <div className="card-body">
                        ...
                        <a href="https://github.com/mabthew/anagram" target="_blank" rel="noopener noreferrer"><AiFillGithub size={42} /></a>
                    </div>
                </div>
                <div className="card">
                    <div className="card-body">
                        ...
                        <a href="https://github.com/mabthew/personal-website" target="_blank" rel="noopener noreferrer"><AiFillGithub size={42} /></a>
                    </div>
                </div>
            </Carousel>
        </div>
